...
#SBATCH --job-name=transform-exp-26-tranformer-dedupe
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-26-tranformer-dedupe_%A_%a.out
#SBATCH --error=logs/transform-exp-26-tranformer-dedupe_%A_%a.err
...
experiments=("exp-26-tranformer-dedupe-row-locks" "exp-26-tranformer-dedupe-table-locks")
