...
declare -a configs_base=(
    # Base configurations
    "--experiment_name exp-5-large/char_"
    "--experiment_name exp-5-large/char_se_ --add_start_end_tokens "
    "--experiment_name exp-5-large/char_r_ --add_row_id "
    "--experiment_name exp-5-large/char_lr_ --add_label_tokens "
    "--experiment_name exp-5-large/char_se_r_ --add_start_end_tokens --add_row_id "
    "--experiment_name exp-5-large/char_se_lr_ --add_start_end_tokens --add_label_tokens "
    "--experiment_name exp-5-large/char_r_lr_ --add_row_id --add_label_tokens "
    "--experiment_name exp-5-large/char_se_r_lr_ --add_start_end_tokens --add_row_id --add_label_tokens "
)
