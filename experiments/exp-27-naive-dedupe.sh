...
declare -a configs_base=(
    # Base configurations
    "--experiment_name exp-27-naive-dedupe-row-locks/char_ --data data/fixed/row_locks.csv --sort_by start_time-dedupe --naive_baseline"
    "--experiment_name exp-27-naive-dedupe-table-locks/char_ --data data/fixed/table_locks.csv --sort_by start_time-dedupe --naive_baseline"
)
