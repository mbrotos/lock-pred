...
#SBATCH --job-name=transform-exp-25-transformer-sorted
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-25-transformer-sorted_%A_%a.out
#SBATCH --error=logs/transform-exp-25-transformer-sorted_%A_%a.err
...
experiments=("exp-25-transformer-row-id-local-sorted-row-locks")
