...
#SBATCH --job-name=transform-exp-19-transformer
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-19-transformer_%A_%a.out
#SBATCH --error=logs/transform-exp-19-transformer_%A_%a.err
...
experiments=("exp-19-transformer-sorted-row-locks" "exp-19-transformer-sorted-table-locks")
