...
#SBATCH --job-name=exp-20-lstm-sorted-row-locks
#SBATCH --account=def-miranska
#SBATCH --output=logs/exp-20-lstm-sorted-row-locks_%A_%a.out
...
declare -a configs_base=(
    # Base configurations
    "--experiment_name exp-20-lstm-sorted-row-locks/char_ --sort_by start_time"
)
