...
#SBATCH --job-name=transform-exp-30-naive-sorted-row-locks
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-30-naive-sorted-row-locks_%A_%a.out
#SBATCH --error=logs/transform-exp-30-naive-sorted-row-locks_%A_%a.err
...
experiments=("exp-30-naive-sorted-row-locks")
