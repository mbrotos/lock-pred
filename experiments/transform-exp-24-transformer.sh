...
#SBATCH --job-name=transform-exp-24-transformer-sorted
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-24-transformer-sorted_%A_%a.out
#SBATCH --error=logs/transform-exp-24-transformer-sorted_%A_%a.err
...
experiments=("exp-24-transformer-row-locks-row-id")
