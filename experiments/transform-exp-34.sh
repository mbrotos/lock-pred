...
#SBATCH --job-name=transform-exp-34-lstm-rounded
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-34-lstm-rounded_%A_%a.out
#SBATCH --error=logs/transform-exp-34-lstm-rounded_%A_%a.err
