...
#SBATCH --job-name=exp-43-lstm-local-rounded-cut
#SBATCH --account=def-miranska
#SBATCH --output=logs/exp-43-lstm-local-rounded-cut%A_%a.out
#SBATCH --error=logs/exp-43-lstm-local-rounded-cut%A_%a.err
