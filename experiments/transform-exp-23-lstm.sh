...
#SBATCH --job-name=transform-exp-23-lstm-sorted
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-23-lstm-sorted_%A_%a.out
#SBATCH --error=logs/transform-exp-23-lstm-sorted_%A_%a.err
...
experiments=("exp-23-lstm-row-id-local-sorted-row-locks")
