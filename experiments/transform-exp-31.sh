...
#SBATCH --job-name=transform-exp-31-lstm-sorted-row-locks
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-31-lstm-sorted-row-locks_%A_%a.out
#SBATCH --error=logs/transform-exp-31-lstm-sorted-row-locks_%A_%a.err
...
experiments=("exp-31-lstm-sorted-row-locks")
