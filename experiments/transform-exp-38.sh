...
#SBATCH --job-name=transform-exp-38-transformer-local-rounded
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-38-transformer-local-rounded_%A_%a.out
#SBATCH --error=logs/transform-exp-38-transformer-local-rounded_%A_%a.err
...
experiments=("exp-38-transformer-local-rounded")
