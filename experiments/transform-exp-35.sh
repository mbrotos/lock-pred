...
#SBATCH --job-name=transform-exp-35-naive-rounded
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-35-naive-rounded_%A_%a.out
#SBATCH --error=logs/transform-exp-35-naive-rounded_%A_%a.err
...
experiments=("exp-35-naive-rounded-row-locks" "exp-35-naive-rounded-table-locks")
