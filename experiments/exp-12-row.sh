...
#SBATCH --job-name=exp-11-row-locks-sep
#SBATCH --account=def-miranska
#SBATCH --output=logs/exp-11-row-locks-sep_%A_%a.out
#SBATCH --error=logs/exp-11-row-locks-sep_%A_%a.err
...
declare -a configs_base=(
    # Base configurations
    "--experiment_name fixed/row_sep/exp-11-row-locks-row_id/char_r_lr_ --add_row_id --add_label_tokens "
)
