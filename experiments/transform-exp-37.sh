...
#SBATCH --job-name=transform-exp-37-lstm-local-rounded
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-37-lstm-local-rounded_%A_%a.out
#SBATCH --error=logs/transform-exp-37-lstm-local-rounded_%A_%a.err
...
experiments=("exp-37-lstm-local-rounded")
