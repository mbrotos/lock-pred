...
#SBATCH --job-name=transform-exp-36-naive-local-rounded
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-36-naive-local-rounded_%A_%a.out
#SBATCH --error=logs/transform-exp-36-naive-local-rounded_%A_%a.err
...
experiments=("exp-36-naive-local-rounded-row-locks")
