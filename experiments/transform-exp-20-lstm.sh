...
#SBATCH --job-name=transform-exp-20-lstm-sorted
#SBATCH --account=def-miranska
#SBATCH --output=logs/transform-exp-20-lstm-sorted_%A_%a.out
#SBATCH --error=logs/transform-exp-20-lstm-sorted_%A_%a.err
...
experiments=("exp-20-lstm-sorted-row-locks" "exp-20-lstm-sorted-table-locks")
