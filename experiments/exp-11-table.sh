...
#SBATCH --job-name=exp-11-table-locks
#SBATCH --account=def-miranska
#SBATCH --output=logs/exp-11-table-locks_%A_%a.out
#SBATCH --error=logs/exp-11-table-locks_%A_%a.err
...
declare -a configs_base=(
    # Base configurations
    "--experiment_name fixed/table_sep/exp-11-table-locks/char_"
)
